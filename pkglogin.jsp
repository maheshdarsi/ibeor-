...
<div class="wrap">
	<div class="header">
        ...
        <div id="menu" >
            ...
            <li><a href="pkglogin.jsp">PKG SERVER</a></li>
			 <li><a href="pkg.jsp">BACK</a></li>
   ...
   <div class="center_content">
    	...
    	<div class="right_content">
        	<div class="title"><h2>KEYGENERATOR </h2></div>
            
            <form action="pkgcheck.jsp" name="f" method="post" onClick="return validation();">
            <table width="301" height="140"  background="images/encryption1.jpg">
