...
<body>
	...
	<th align="center"height="41"><font id="logo">VIEW</font></th>
	<th align="center"height="41"><font id="logo">DOWNLOAD</font></th>
	</tr>
	...
	<td align="center"><a href="view.jsp?fileid=<%=rs.getString("id")%>"><input type="image" src="images/upload.png"></a></td>
     <td align="center"><a href="download1.jsp?fileid=<%=rs.getString("id")%>"><input type="image" src="images/upload.png"></a></td>
